...
import com.university.wanstudy.adapters.VideoAdapter;
import com.university.wanstudy.fragments.DirFragment;
import com.university.wanstudy.fragments.IndroduceFragment;
import com.university.wanstudy.fragments.PingLunFragment;
import com.university.wanstudy.utils.CommonUtil;
import com.university.wanstudy.utils.LightnessController;
import com.university.wanstudy.utils.VolumeController;
 ...
 */
public class PlayActivity extends AppCompatActivity implements MediaPlayer.OnPreparedListener, CompoundButton.OnCheckedChangeListener, View.OnTouchListener, SeekBar.OnSeekBarChangeListener, Handler.Callback {
    ...
    private void initView() {
        videoTabLayout = ((TabLayout) findViewById(R.id.videoTableLayout));
        videoTabLayout.setTabMode(TabLayout.MODE_FIXED);
        videoViewPager = ((ViewPager) findViewById(R.id.videoView_viewpager));
        List<Fragment> data=new ArrayList<>();
        List<String> title=new ArrayList<>();
        data.add(new IndroduceFragment(id));
        data.add(new DirFragment(id));
        data.add(new PingLunFragment(id));
        Log.e(TAG, "看看有没有值？——————" + id);
        title.add("简介");
        title.add("目录");
        title.add("评论");
        videoAdapter=new VideoAdapter(getSupportFragmentManager(),data,title);
